// DE10_Standard_VIP_Qsys_alt_vip_cl_vfb_0.v
...
`timescale 1 ps / 1 ps
module DE10_Standard_VIP_Qsys_alt_vip_cl_vfb_0 #(
		...
		output wire [31:0] mem_master_wr_writedata,     //              .writedata
		output wire [3:0]  mem_master_wr_byteenable,    //              .byteenable
		...
		input  wire [31:0] mem_master_rd_readdata,      //              .readdata
		input  wire        mem_master_rd_readdatavalid  //              .readdatavalid
	);

	wire         video_in_resp_av_st_resp_valid;         // video_in_resp:av_st_resp_valid -> wr_ctrl:vib_resp_valid
	wire  [63:0] video_in_resp_av_st_resp_data;          // video_in_resp:av_st_resp_data -> wr_ctrl:vib_resp_data
	wire         video_in_resp_av_st_resp_ready;         // wr_ctrl:vib_resp_ready -> video_in_resp:av_st_resp_ready
	wire         video_in_resp_av_st_resp_startofpacket; // video_in_resp:av_st_resp_startofpacket -> wr_ctrl:vib_resp_startofpacket
	wire         video_in_resp_av_st_resp_endofpacket;   // video_in_resp:av_st_resp_endofpacket -> wr_ctrl:vib_resp_endofpacket
	...
	wire         video_in_cmd_av_st_dout_valid;          // video_in_cmd:av_st_dout_valid -> wr_ctrl:vib_data_valid
	wire  [47:0] video_in_cmd_av_st_dout_data;           // video_in_cmd:av_st_dout_data -> wr_ctrl:vib_data_data
	wire         video_in_cmd_av_st_dout_ready;          // wr_ctrl:vib_data_ready -> video_in_cmd:av_st_dout_ready
	wire         video_in_cmd_av_st_dout_startofpacket;  // video_in_cmd:av_st_dout_startofpacket -> wr_ctrl:vib_data_startofpacket
	wire         video_in_cmd_av_st_dout_endofpacket;    // video_in_cmd:av_st_dout_endofpacket -> wr_ctrl:vib_data_endofpacket
	wire         wr_ctrl_vib_cmd_valid;                  // wr_ctrl:vib_cmd_valid -> video_in_cmd:av_st_cmd_valid
	wire  [63:0] wr_ctrl_vib_cmd_data;                   // wr_ctrl:vib_cmd_data -> video_in_cmd:av_st_cmd_data
	wire         wr_ctrl_vib_cmd_ready;                  // video_in_cmd:av_st_cmd_ready -> wr_ctrl:vib_cmd_ready
	wire         wr_ctrl_vib_cmd_startofpacket;          // wr_ctrl:vib_cmd_startofpacket -> video_in_cmd:av_st_cmd_startofpacket
	wire         wr_ctrl_vib_cmd_endofpacket;            // wr_ctrl:vib_cmd_endofpacket -> video_in_cmd:av_st_cmd_endofpacket
	...
	wire  [47:0] wr_ctrl_pkt_wr_data_data;               // wr_ctrl:pkt_wr_data_data -> pkt_trans_wr:av_st_din_data
	...
	wire  [47:0] rd_ctrl_vob_data_data;                  // rd_ctrl:vob_data_data -> video_out:av_st_din_data
	...
	wire  [47:0] pkt_trans_rd_av_st_dout_data;           // pkt_trans_rd:av_st_dout_data -> rd_ctrl:pkt_rd_data_data
	...
	alt_vip_vfb_wr_ctrl #(
		...
		.MAX_WIDTH                    (720),
		.MAX_HEIGHT                   (480),
		.MAX_SYMBOLS_IN_ANC_PACKET    (10)
	) wr_ctrl (
		.clock                     (main_clock),                             //  main_clock.clk
		.reset                     (main_reset),                             //  main_reset.reset
		.vib_data_valid            (video_in_cmd_av_st_dout_valid),          //    vib_data.valid
		.vib_data_startofpacket    (video_in_cmd_av_st_dout_startofpacket),  //            .startofpacket
		.vib_data_endofpacket      (video_in_cmd_av_st_dout_endofpacket),    //            .endofpacket
		.vib_data_data             (video_in_cmd_av_st_dout_data),           //            .data
		.vib_data_ready            (video_in_cmd_av_st_dout_ready),          //            .ready
		...
		.vib_resp_valid            (video_in_resp_av_st_resp_valid),         //    vib_resp.valid
		.vib_resp_startofpacket    (video_in_resp_av_st_resp_startofpacket), //            .startofpacket
		.vib_resp_endofpacket      (video_in_resp_av_st_resp_endofpacket),   //            .endofpacket
		.vib_resp_data             (video_in_resp_av_st_resp_data),          //            .data
		.vib_resp_ready            (video_in_resp_av_st_resp_ready),         //            .ready
