...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../DE10_Standard_QSYS.sopcinfo
...
# Design Name 
# setting SOPC_NAME is DE10_Standard_QSYS
SOPC_NAME := DE10_Standard_QSYS
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4041038
SOPC_SYSID_FLAG += --sidp=0x4041038
ELF_PATCH_FLAG  += --sidp 0x4041038

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1484302006
SOPC_SYSID_FLAG += --timestamp=1484302006
ELF_PATCH_FLAG  += --timestamp 1484302006
