...
// $Id: //acds/rel/11.1/ip/merlin/seq_altera_merlin_master_translator/seq_altera_merlin_master_translator.sv#1 $
// $Revision: #1 $
// $Date: 2011/08/15 $
// $Author: max $
...
module seq_altera_merlin_master_translator #(
    parameter
					 AV_ADDRESS_W                      = 32,
					 AV_DATA_W                         = 32,
					 AV_BURSTCOUNT_W                   = 4,
					 ...
					 UAV_BURSTCOUNT_W                  = 10,
					    ...
					    //Avalon-MM !Master
					    input                                                         av_write,		//*** SV-to-V: 'input reg=>input 
					    input                                                         av_read,		//*** SV-to-V: 'input reg=>input 
   ...
   always@(posedge clk, negedge reset_n) begin
      ...
      if(~reset_n) begin
	 address_register    <= 0;		//*** SV-to-V: '0=>0 
	 burstcount_register <= 0;		//*** SV-to-V: '0=>0 
   ...
   always@* begin
	 ...
	 uav_burstcount_pre = 0;		//*** SV-to-V: '0=>0 
