...
module soc_system_mm_interconnect_2 (
	...
	wire  [105:0] rsp_demux_002_src0_data;                                                    // rsp_demux_002:src0_data -> crosser_001:in_data
	wire          rsp_demux_002_src0_ready;                                                   // crosser_001:in_ready -> rsp_demux_002:src0_ready
	wire    [6:0] rsp_demux_002_src0_channel;                                                 // rsp_demux_002:src0_channel -> crosser_001:in_channel
	...
	wire  [105:0] crosser_001_out_data;                                                       // crosser_001:out_data -> rsp_mux:sink2_data
	wire          crosser_001_out_ready;                                                      // rsp_mux:sink2_ready -> crosser_001:out_ready
	wire    [6:0] crosser_001_out_channel;                                                    // crosser_001:out_channel -> rsp_mux:sink2_channel
	...
	soc_system_mm_interconnect_2_cmd_mux_002 cmd_mux_002 (
		.clk                 (vga_stream_out_clk_clk),                                        //       clk.clk
		.reset               (alt_vip_vfr_vga_clock_reset_reset_reset_bridge_in_reset_reset), // clk_reset.reset
