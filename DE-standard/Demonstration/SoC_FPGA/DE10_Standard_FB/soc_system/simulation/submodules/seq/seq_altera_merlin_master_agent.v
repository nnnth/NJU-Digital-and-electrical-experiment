...
// $Id: //acds/rel/11.1/ip/merlin/seq_altera_merlin_master_agent/seq_altera_merlin_master_agent.sv#1 $
// $Revision: #1 $
// $Date: 2011/08/15 $
// $Author: max $
...
module seq_altera_merlin_master_agent
#(
    // -------------------
...
(
    ...
    always @* begin
        cp_data = 0; // Default assignment; override below as needed.		//*** SV-to-V: '0=>0 
