...
// $Id: //acds/rel/11.1/ip/merlin/seq_altera_merlin_traffic_limiter/seq_altera_merlin_traffic_limiter.sv#1 $
// $Revision: #1 $
// $Date: 2011/08/15 $
// $Author: max $
...
module seq_altera_merlin_traffic_limiter
#(
...
(
    ...
    generate begin : pipelined_limiter
        if (PIPELINED == 1) begin
            seq_altera_avalon_st_pipeline_base
            #(
    ...
    always @(posedge clk, negedge reset_n) begin
	    ...
	    // remove due to synthesis issues
`ifdef NOTDEF
