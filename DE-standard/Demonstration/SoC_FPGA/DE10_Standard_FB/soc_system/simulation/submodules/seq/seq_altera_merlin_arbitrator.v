...
// $Id: //acds/main/ip/merlin/seq_altera_merlin_std_arbitrator/seq_altera_merlin_std_arbitrator_core.sv#3 $
// $Revision: #3 $
// $Date: 2010/07/07 $
// $Author: jyeap $
...
Modelsim 6.3g has trouble with the expression, evaluating it to 0'.  But 		//*** SV-to-V: 'X=>0 
...
module seq_altera_merlin_arbitrator
#(
