...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_router_004.sv"                               -work router_004                                                       -cdslib ./cds_libs/router_004.cds.lib                                                      
